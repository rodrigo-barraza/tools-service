...
const TOOL_DOMAINS = {
  ...
  create_discord_poll: "Discord",
  create_discord_thread: "Discord",
  schedule_discord_reminder: "Discord",
  list_discord_reminders: "Discord",
  cancel_discord_reminder: "Discord",
  set_discord_nickname: "Discord",
